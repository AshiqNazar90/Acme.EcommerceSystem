...
namespace Acme.EcommerceSystem.Migrations
{
    ...
    [Migration("20220314063050_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.EcommerceSystem.UserAccounts.UserAccount", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Acme.EcommerceSystem.UserProfiles.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.EcommerceSystem.UserTransactions.UserTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.EcommerceSystem.UserAccounts.UserAccount", b =>
                {
                    b.HasOne("Acme.EcommerceSystem.UserProfiles.UserProfile", "UserProfile")
                        .WithMany()
                        .HasForeignKey("UserProfileId");

                    b.HasOne("Acme.EcommerceSystem.UserTransactions.UserTransaction", "UserTransaction")
                        .WithMany()
