...
[DependsOn(
    ...
    typeof(EcommerceSystemTestBaseModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class EcommerceSystemEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        using (var context = new EcommerceSystemDbContext(options))
        {
